...
describe("El juego del impostor", function() {
	...
	it("Comprobar valore de la partid",function(){
		var codigo = juego.crearPartida(3,usr);
		expect(codigo).toBe("fallo");
		codigo = juego.crearPartida(2,usr);
  	...
  	describe("el usr Pepe crea una partida de 4 jugadores",function(){
		...
		it("no se puede crear partida si el num no esta entra 3 y 11",function(){
			var codigo = juego.crearPartida(3,usr);
			expect(codigo).toEqual("fallo");
		...
		/*
			juego.unirAPartida(codigo,"thomas");
			var num = Object.keys(juego.partidas[codigo].usuarios)
		*/
